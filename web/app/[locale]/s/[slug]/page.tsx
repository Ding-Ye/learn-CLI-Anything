...
function guessUpstreamFile(slug: string): string | null {
  ...
  const map: Record<string, string> = {
    "s01-min-harness": "s01-min-harness.py",
    "s02-skill-md": "s02-skill-md.py",
    "s03-skill-gen": "s03-skill-gen.py",
    "s04-preview-bundle": "s04-preview-bundle.py",
    "s05-repl-skin": "s05-repl-skin.py",
    "s06-hub-registry": "s06-hub-registry.py",
    "s07-installer": "s07-installer.py",
    "s08-verify-plugin": "s08-verify-plugin.md",
    "s09-anygen-remote": "s09-anygen-remote.md",
    "s10-publish-flow": "s10-publish-flow.yml",
  };
