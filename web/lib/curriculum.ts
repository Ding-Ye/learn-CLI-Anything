...
export const CURRICULUM: ChapterMeta[] = [
  ...
  { slug: "s06-hub-registry",    num: "s06",    title: { zh: "CLI-Hub 注册中心",                   en: "CLI-Hub registry" },                              available: true  },
  { slug: "s07-installer",       num: "s07",    title: { zh: "多后端安装器",                       en: "Multi-backend installer" },                       available: true  },
